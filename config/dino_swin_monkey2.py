...
data_root = '/mnt/prj002/Monkey_Challenge/Monkey_Challenge_Dataset/g_data/40x/Data_40x_512_2/'
backend_args = None
train_pipeline = [
...
train_dataloader = dict(
    ...
    dataset=dict(
        type='CocoDataset',
        data_root=
        '/mnt/prj002/Monkey_Challenge/Monkey_Challenge_Dataset/g_data/40x/Data_40x_512_2/',
        ann_file='json2/train.json',
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=
    '/mnt/prj002/Monkey_Challenge/Monkey_Challenge_Dataset/g_data/40x/Data_40x_512_2/json2/val.json',
    metric='bbox',
    format_only=False,
    backend_args=None,
    metric_items=None)
...
param_scheduler = [
    dict(
        type='LinearLR', start_factor=0.0001, by_epoch=False, begin=0, end=10),
    dict(
        type='CosineAnnealingLR',
        eta_min=8.000000000000001e-07,
        begin=15,
        end=60,
        T_max=45,
        by_epoch=True,
...
launcher = 'none'
work_dir = './work_dirs/dino_swin_monkey2'
